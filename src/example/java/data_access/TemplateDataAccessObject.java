 ...
 *
 * <p>
 * You can also refer to the lab 5 code for signing up a new user and other use
 * cases.
 * </p>
 * See
 * <a href=
 ...
 * throw new
 * DataAccessException("message could not be found or password was incorrect");
 * }
 * else {
 ...
 * final Request request = new Request.Builder()
 * .url(String.format(
 * "http://vm003.teach.cs.toronto.edu:20112/user?username=%s", username))
